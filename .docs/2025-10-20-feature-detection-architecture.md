...
> 
> This document describes the **recommended architecture** for feature detection when you're ready to implement it. See `.docs/implementation-status.md` for current status.
